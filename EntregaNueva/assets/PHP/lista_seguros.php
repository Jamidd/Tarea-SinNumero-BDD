...
<body>
    ...
    <div class="container space">
        <?php 
            ...
            $query1 = "SELECT seguro.nombre, seguro.valor_mensual, ruz.fecha_de_contratacion, ruz.fecha_de_expiracion
            FROM rusuarioseguro AS ruz, seguro 
            WHERE ruz.id_usuario::int = '$id' AND ruz.id_seguro::int = seguro.id_seguro::int;";
            ...
            echo "<table class=\"table querytable\"><thead><tr><th class=\"querytext\" scope=\"col\">Nombre Seguro</th><th class=\"querytext\" scope=\"col\">Valor Mensual</th><th class=\"querytext\" scope=\"col\">Fecha contratación</th><th class=\"querytext\" scope=\"col\">Fecha expiración</th></tr></thead><tbody>";
            foreach ($nombres1 as $persona1) {
                echo "<tr><td class=\"querytext\">$persona1[0]</td><td class=\"querytext\">$persona1[1]</td><td class=\"querytext\">$persona1[2]</td><td class=\"querytext\">$persona1[3]</td></tr>";
            }
            echo "</tbody></table>";
        ?>
    </div>
