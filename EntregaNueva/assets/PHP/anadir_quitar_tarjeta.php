...
<body>
    ...
    <div class="container space">
        <a class="btn btn-warning" href="agregar_tarjeta.php" role="button">Solicitar Tarjeta</a>
    </div>
    <div class="container">
        <div class="row" style="height: 50px;"></div>
    </div>
    <div class="container space">
        <form action="quitar_tarjeta.php" method="post">
            <div class="form-group">
                <label class="b-label" for="user">Id Tarjeta:</label><br>
                <input type="text" class="form_control" name="tid">
            </div>
            <button type="submit" class="btn btn-warning" value="Login">Quitar Tarjeta</button>
        </form>
    </div>
</body>
</html>