...
#
				...
				$query_tiendas_productos = pg_query($conn, "SELECT * FROM tienda WHERE tienda.id_tienda = $id::varchar");

				$query_tiendas_servicios = pg_query($conn, "SELECT * FROM tiendadeservicio AS tds WHERE tds.id_tienda_s = $id::varchar");
